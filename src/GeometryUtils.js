...
const GeometryUtils = {
	...
	randomPointsInGeometry: function ( geometry, n ) {
		...
		for ( i = 0; i < il; i ++ ) {
			...
			vB = vertices[ face.b ];
			vC = vertices[ face.c ];
      const triangleArea = function(vA, vB, vC) {
      ...
      const randomPointInTriangle = function (vectorA, vectorB, vectorC) {

        var vector = new THREE.Vector3();

        const doThis = function ( vectorA, vectorB, vectorC ) {
        ...
        let answer = doThis(vectorA, vectorB, vectorC);
        return answer;

      }

      const randomPointInFace = function ( face, geometry ) {
